...
import { LayoutDashboard, FileText, Layers, Key, Share2, Menu, X, LogOut } from 'lucide-react'
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    ...
                    isActive
                      ? 'bg-surface-2 text-text-primary border-l-2 border-accent pl-[10px]'
...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-surface-0">
      {/* Desktop sidebar */}
      <aside className="hidden md:flex w-[240px] shrink-0 flex-col border-r border-border bg-surface-1 fixed top-0 left-0 h-full z-40">
        <SidebarContent />
      </aside>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="md:hidden fixed top-0 left-0 h-full w-[240px] z-50 bg-surface-1 border-r border-border"
            >
