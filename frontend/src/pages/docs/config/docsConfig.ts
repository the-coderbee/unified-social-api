  ...
  "social_accounts": []
    ...
    statusCodes: [
      ...
      { code: 400, description: "User with this email already exists." },
      {
        code: 422,
        description:
          "Validation error — invalid email or password too short/long.",
      },
    ...
    params: [
      {
        ...
        location: "body",
        description:
          "The user's email address (OAuth2 form field name is `username`).",
      },
      {
        name: "password",
        type: "string",
    ...
    params: [
      {
        ...
        required: true,
        location: "query",
        description: "Authorization code from Google's redirect.",
      },
      {
        name: "state",
        type: "string",
        required: true,
        location: "query",
        description: "CSRF state token from the initialize step.",
      },
    ],
    responseExample: `{
  "access_token": "eyJhbGciOiJIUzI1NiJ9...",
  ...
  "token_type": "bearer"
    ...
    statusCodes: [
      { code: 200, description: "OAuth login successful." },
      {
        code: 400,
        description:
          "Invalid or expired state, or email not retrieved from provider.",
      },
      { code: 500, description: "Internal server error." },
    ],
  },
    ...
    params: [
      {
        ...
        required: true,
        location: "query",
        description: "Authorization code from GitHub's redirect.",
      },
      {
        name: "state",
        type: "string",
...
export const postsEndpoints: DocEndpoint[] = [
    ...
    params: [
      {
        ...
        location: "body",
        description:
          "The text content to publish. Platform-specific character limits apply.",
      },
      {
        name: "platforms",
        type: "string[]",
        ...
        location: "body",
        description:
          'Array of platform identifiers to publish to. Valid values: "x", "discord", "mastodon", "linkedin".',
      },
      {
        name: "options",
        type: "object",
        ...
        location: "body",
        description:
          "Platform-specific options (e.g., channel ID for Discord).",
      },
    ],
    requestExample: `{
    ...
    statusCodes: [
      {
        code: 200,
        description:
          "Post created. Check `status` field — may be `success`, `partial_success`, or `failed`.",
      },
    ...
    params: [
      {
        ...
        location: "query",
        description:
          'Filter by post status. One of: "success", "failed", "partial_success".',
      },
    ],
    responseExample: `[
  {
    ...
    params: [
      {
        ...
        required: true,
        location: "path",
        description: "The UUID of the post to retry.",
      },
    ],
    responseExample: `{
  "id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
  ...
  "not_connected_platforms": []
    ...
    statusCodes: [
      ...
      {
        code: 400,
        description: "Post already fully successful — cannot retry.",
      },
      { code: 401, description: "Missing or invalid access token." },
  ...
  },
  {
    ...
    description: "Fetch a single post and its per-platform results by ID.",
    authRequired: true,
    params: [
      {
        name: "post_id",
  ...
  "not_connected_platforms": []
    ...
    statusCodes: [
      ...
      { code: 401, description: "Missing or invalid access token." },
      {
        code: 404,
        description:
          "Post not found or does not belong to the authenticated user.",
      },
    ],
  },
];
...
export const socialEndpoints: DocEndpoint[] = [
  {
    ...
    description:
      "Generate an OAuth2 authorization URL for linking a social platform to the authenticated user's account. Supported platforms: `x`, `discord`, `mastodon`, `linkedin`. Redirect the user to the returned `auth_url`.",
    authRequired: false,
    params: [
      {
        name: "platform_name",
        ...
        location: "path",
        description:
          'Platform identifier. One of: "x", "discord", "mastodon", "linkedin".',
      },
      {
        ...
        location: "query",
        description:
          'Required for Mastodon — the instance domain to authorize against (e.g. "mastodon.social").',
      },
    ],
    responseExample: `{
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        required: true,
        location: "body",
        description: "Authorization code from the platform OAuth redirect.",
      },
      {
        name: "state",
        type: "string",
      ...
      },
      {
        ...
        location: "body",
        description:
          'Required for Mastodon — the same instance domain used in the login-URL request (e.g. "mastodon.social").',
      },
    ],
    requestExample: `{
  ...
  "created_at": "2024-01-15T10:30:00Z"
    ...
    statusCodes: [
      ...
      {
        code: 400,
        description: "Invalid or expired state, or missing access token.",
      },
      { code: 401, description: "Missing or invalid user access token." },
      {
        code: 404,
        description:
          "Platform not supported, or no account ID returned from platform.",
      },
    ],
  },
  {
    ...
    params: [
      {
        ...
        location: "path",
        description:
          'Platform identifier to unlink. One of: "x", "discord", "mastodon", "linkedin".',
      },
    ],
    statusCodes: [
      {
        code: 204,
        description: "Account unlinked successfully. No response body.",
      },
      { code: 401, description: "Missing or invalid access token." },
  ...
  },
  {
    ...
    statusCodes: [
      {
        code: 200,
        description: "Array of linked accounts. Empty array if none.",
      },
      { code: 401, description: "Missing or invalid access token." },
    ],
  },
...
export const apiKeysEndpoints: DocEndpoint[] = [
    ...
    params: [
      {
        ...
        location: "body",
        description:
          'A descriptive label for the key (e.g., "Production Server").',
      },
      {
        name: "scopes",
        type: "string[]",
        ...
        location: "body",
        description:
          'Array of permission scopes. Valid values: "posts:write", "posts:read", "platforms:read", "keys:read".',
      },
    ],
    requestExample: `{
  ...
  "name": "Production Server",
  "scopes": ["posts:write", "posts:read"],
  "api_key": "usa_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
  "created_at": "2024-01-15T10:30:00Z"
}`,
    statusCodes: [
      {
        code: 201,
        description:
          "API key created. The `api_key` field will not be shown again.",
      },
      { code: 401, description: "Missing or invalid access token." },
      {
        code: 422,
        description: "Validation error — invalid scope values or missing name.",
      },
    ],
  },
  {
    ...
    responseExample: `[
  {
    ...
    statusCodes: [
      {
        code: 200,
        description: "Array of API keys. Empty array if none exist.",
      },
      { code: 401, description: "Missing or invalid access token." },
    ],
  },
  {
    ...
    statusCodes: [
      ...
      {
        code: 403,
        description: "API key does not belong to the authenticated user.",
      },
...
export const docsSections: DocSection[] = [
  ...
  },
  {
    ...
    title: "API Keys",
    description:
      "Generate and manage scoped API keys for server-to-server access",
    icon: "Key",
    anchors: [
